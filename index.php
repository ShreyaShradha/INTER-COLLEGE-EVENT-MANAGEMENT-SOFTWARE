...
<title>Inter-College Event Software Login</title>
<style>
.button {
  border: none;
  border-radius: 4px;
...
echo "<table width='100%' border='1'>";
  ...
  echo "User Login &nbsp&nbsp &nbsp&nbsp<p style='color:yellow;font-size:18px; display:inline; font-weight: bold;'> INTER-COLLEGE &nbspEVENT &nbspMANAGEMENT &nbspSOFTWARE";
  echo "</td>";
